...
var _graphView = require("./views/graphView");
...
const startApp = function() {
    _searchViewDefault.default.addSearchListener(searchResultsController);
    _recipeViewDefault.default.addRenderListener(recipesController);
};
startApp();

},{"./model":"6Yfb5","./views/searchView":"51HTZ","./views/graphView":"7E4DN","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./views/recipeView":"9q0mt","core-js/stable":"eIyVg","regenerator-runtime":"cH8Iq","./views/resultsView":"a6WEO"}],"6Yfb5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const loadRecipe = async function(id) {
    try {
        const data = await _helpers.AJAX(`${_config.URL}${id}?key=${_config.KEY}`);
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await _helpers.AJAX(`${_config.URL}complexSearch?query=${query}&apiKey=${_config.KEY}`);
        console.log(data);
...
},{"regenerator-runtime":"cH8Iq","./config":"beA2m","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"51HTZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"7E4DN":[function(require,module,exports) {
...
},{"./View":"8rtS4","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"8rtS4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
